    ...
    def _extract_response(self, item_id, query, note='Downloading API JSON', headers=None,
        ...
        while True:
            ...
            if not traverse_obj(response, *variadic(check_get_keys)):
                ...
                # keep in mind that this is rather... rough to say the least. it's not exact and I
                # couldn't bother myself to make it so
                # THIS IS WHAT YOU SHOULD MODIFY:
                RETRY_COUNT = 3
                # somehow I broke the above logging line so I'm going to make my own
                print("\033[93mWARNING: \033[0m[youtube] Incomplete data received. Retrying (" + str(counter) + "/" + str(RETRY_COUNT) + ")...")
                should_retry = True
